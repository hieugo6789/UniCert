...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 py-12 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10 px-2 md:px-4">
            ...
            <div 
              ...
              className=" p-6 md:p-8 rounded-xl shadow-lg fade-in transform hover:scale-105 transition duration-300 cursor-pointer hover:shadow-2xl"
            >
              <div className="w-12 h-12 md:w-16 md:h-16 bg-purple-100 dark:bg-purple-900 rounded-2xl flex items-center justify-center mb-4 md:mb-6 mx-auto">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-purple-600 dark:text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-purple-800 dark:text-purple-300 text-center">Why Get Certified?</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 text-center leading-relaxed">Discover how our certifications can enhance your career prospects and professional growth.</p>
            </div>
            ...
            <div 
              ...
              className=" p-6 md:p-8 rounded-xl shadow-lg fade-in transform hover:scale-105 transition duration-300 cursor-pointer hover:shadow-2xl"
            >
              <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-100 dark:bg-blue-900 rounded-2xl flex items-center justify-center mb-4 md:mb-6 mx-auto">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-blue-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                </svg>
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-blue-800 dark:text-blue-300 text-center">Best Certificates</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 text-center leading-relaxed">Explore our curated selection of industry-leading certifications for your career path.</p>
            </div>
            ...
            >
              <div className="w-12 h-12 md:w-16 md:h-16 bg-green-100 dark:bg-green-900 rounded-2xl flex items-center justify-center mb-4 md:mb-6 mx-auto">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-green-600 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-green-800 dark:text-green-300 text-center">Exam Preparation</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 text-center leading-relaxed">Comprehensive study materials and practice tests to ensure your success.</p>
            </div>
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-red-800 dark:text-red-300 text-center">Learning Pathway</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 text-center leading-relaxed">Follow our structured learning path from beginner to expert certification levels.</p>
            </div>
          </div>
        </div>
      </div>

      <section id="global-recognition-section" className="py-12 md:py-16 lg:py-20 dark:bg-gray-900">
        <div className="text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-blue-700 dark:text-blue-300 fade-in text-4xl md:text-6xl lg:text-7xl font-extrabold mt-2">UniCert?</h1>
          <p className="text-lg md:text-xl font-thin w-full md:w-4/5 lg:w-2/3 mx-auto mt-6 md:mt-8 fade-in text-gray-800 dark:text-gray-200">
      ...
      <section id="expert-support-section" className="py-12 md:py-16 lg:py-20 bg-gray-50 dark:bg-gray-900">
      ...
      <section id="practice-tests-section" className="py-12 md:py-16 lg:py-20 dark:bg-gray-900">
        <div className="w-full flex flex-col text-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-6 md:mt-8 text-lg md:text-xl max-w-4xl mx-auto text-gray-800 dark:text-gray-200">
      ...
      <section id="flexible-learning-section" className="py-12 md:py-16 lg:py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className={`text-center fade-in uppercase text-4xl md:text-5xl lg:text-6xl font-extrabold bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.indigo.400),theme(colors.indigo.100),theme(colors.sky.400),theme(colors.fuchsia.400),theme(colors.sky.400),theme(colors.indigo.100),theme(colors.indigo.400))]`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 text-center py-8 md:py-12 lg:py-16">
            <div className="p-4 md:p-6 bg-gray-200 dark:bg-gray-700 rounded-lg shadow-md fade-in">
              <h2 className="text-lg md:text-xl font-bold dark:text-white">Beginner</h2>
              <p className="mt-2 dark:text-gray-300">Step 1: Lay the foundations</p>
            ...
            <div className="p-4 md:p-6 bg-blue-200 dark:bg-blue-900 rounded-lg shadow-md fade-in">
              <h2 className="text-lg md:text-xl font-bold dark:text-white">Associate</h2>
              <p className="mt-2 dark:text-gray-300">Step 2: Build proficiency</p>
              <div className="m-auto w-full h-48 md:h-64 mt-4 fade-in">
                <img
            ...
            <div className="p-4 md:p-6 bg-green-200 dark:bg-green-900 rounded-lg shadow-md fade-in">
              <h2 className="text-lg md:text-xl font-bold dark:text-white">Professional</h2>
              <p className="mt-2 dark:text-gray-300">Step 3: Achieve expertise</p>
              <div className="m-auto w-full h-48 md:h-64 mt-4 fade-in">
                <img
            ...
            <div className="p-4 md:p-6 bg-purple-200 dark:bg-purple-900 rounded-lg shadow-md fade-in">
              <h2 className="text-lg md:text-xl font-bold dark:text-white">Specialty</h2>
              <p className="mt-2 dark:text-gray-300">Step 4: Mastery in a niche</p>
              <div className="m-auto w-full h-48 md:h-64 mt-4 fade-in">
                <img
