...
const MajorCard = (props: allMajorPaginationData) => {
  ...
  return (
    ...
    >
      <img        
        src={props.majorImage ? props.majorImage : defaultCertThumb}
        alt="Major Image"
        className="w-full h-44 object-cover mb-4 rounded-xl"
      />
      <h3 className="text-lg font-semibold line-clamp-2 h-14">{props.majorName}</h3>
    </div>
  );
};
