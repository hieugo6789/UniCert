    ...
    <div>
      ...
      {schedule.length > 0 ? (
        ...
        <div className="bg-purple-50 dark:bg-purple-900 rounded-xl p-6 text-center">
          <svg className="w-12 h-12 text-purple-400 dark:text-purple-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <p className="text-purple-600 dark:text-purple-300 font-medium">No exam sessions available at the moment.</p>
        </div>
      )}
    </div>
    ...
    <div>
      ...
      {course.length > 0 ? (
        ...
        <div className="bg-purple-50 dark:bg-purple-900 rounded-xl p-6 text-center">
          ...
          <p className="text-purple-600 dark:text-purple-300 font-medium">No training courses available at the moment.</p>
        </div>
      )}
    </div>
  </div>
